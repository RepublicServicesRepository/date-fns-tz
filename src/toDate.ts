...
import tzPattern from './tzPattern';
...
export function toInteger(dirtyNumber) {
 ...
 * @param [options.additionalDigits=2] - the additional number of digits in the extended year format
